...
class _AdminOrdersScreenState extends ConsumerState<AdminOrdersScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Manage Orders', style: typo.headlineSmall.copyWith(fontWeight: FontWeight.w800)),
        backgroundColor: colors.surfaceContainerLowest,
              ...
              data: (orders) {
                var filtered = orders.where((o) {
                  ...
                  if (_searchQuery.isNotEmpty) {
                    ...
                    return (o['listing_title'] ?? '').toString().toLowerCase().contains(q) ||
                        (o['buyer_name'] ?? '').toString().toLowerCase().contains(q) ||
                ...
                if (filtered.isEmpty) {
                  return Center(
                    child: Text('No orders found.', style: typo.bodyLarge.copyWith(color: colors.onSurfaceVariant)),
                  );
                }
                    ...
                    child: DataTable(
                      ...
                      rows: filtered.map((o) {
                        ...
                        return DataRow(cells: [
                          ...
                          DataCell(Text('\$${(o['total_price'] ?? 0).toStringAsFixed(0)}')),
                          DataCell(Container(
                          ...
                          DataCell(Text(
                            o['created_at'] != null
                                ? DateFormat('MM/dd/yy').format(DateTime.parse(o['created_at']))
                                : '-',
                          )),
                        ]);
                      }).toList(),
