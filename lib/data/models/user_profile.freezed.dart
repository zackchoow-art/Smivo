...
@JsonKey(name: 'push_notifications_enabled') bool get pushNotificationsEnabled;// Push preference for new chat messages
@JsonKey(name: 'push_messages') bool get pushMessages;// Push preference for order status updates
@JsonKey(name: 'push_order_updates') bool get pushOrderUpdates;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,email,displayName,avatarUrl,school,schoolId,isVerified,schoolData,createdAt,updatedAt,emailNotificationsEnabled,onesignalPlayerId,pushNotificationsEnabled,pushMessages,pushOrderUpdates);
...
switch (_that) {
case _UserProfile() when $default != null:
return $default(_that.id,_that.email,_that.displayName,_that.avatarUrl,_that.school,_that.schoolId,_that.isVerified,_that.schoolData,_that.createdAt,_that.updatedAt,_that.emailNotificationsEnabled,_that.onesignalPlayerId,_that.pushNotificationsEnabled,_that.pushMessages,_that.pushOrderUpdates);case _:
  return orElse();
