...
class AppTextStyles {
  ...
  static TextStyle get logo => displayLarge.copyWith(
  ...
  static TextStyle get buttonLarge =>
      labelLarge.copyWith(color: AppColors.onPrimary, fontSize: 18);
  static TextStyle get buttonSecondary =>
      labelLarge.copyWith(color: AppColors.primary, fontSize: 16);
  static TextStyle get footerText => bodySmall;
  static TextStyle get labelUppercase =>
      labelSmall.copyWith(letterSpacing: 0.7);
}
