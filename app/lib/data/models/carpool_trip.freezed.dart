...
@JsonKey(name: 'luggage_limit') String? get luggageLimit;@JsonKey(name: 'approval_mode') String get approvalMode; String get status;@JsonKey(name: 'closing_time') DateTime? get closingTime; String? get note;@JsonKey(name: 'created_at') DateTime get createdAt;@JsonKey(name: 'updated_at') DateTime get updatedAt;// Nested join — populated only by specific join queries
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,creatorId,schoolId,role,departureAddress,departureLat,departureLng,departurePlaceId,destinationAddress,destinationLat,destinationLng,destinationPlaceId,departureTime,estimatedArrivalTime,totalSeats,availableSeats,luggageLimit,approvalMode,status,closingTime,note,createdAt,updatedAt,creator,const DeepCollectionEquality().hash(members)]);

@override
String toString() {
  return 'CarpoolTrip(id: $id, creatorId: $creatorId, schoolId: $schoolId, role: $role, departureAddress: $departureAddress, departureLat: $departureLat, departureLng: $departureLng, departurePlaceId: $departurePlaceId, destinationAddress: $destinationAddress, destinationLat: $destinationLat, destinationLng: $destinationLng, destinationPlaceId: $destinationPlaceId, departureTime: $departureTime, estimatedArrivalTime: $estimatedArrivalTime, totalSeats: $totalSeats, availableSeats: $availableSeats, luggageLimit: $luggageLimit, approvalMode: $approvalMode, status: $status, closingTime: $closingTime, note: $note, createdAt: $createdAt, updatedAt: $updatedAt, creator: $creator, members: $members)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,creatorId,schoolId,role,departureAddress,departureLat,departureLng,departurePlaceId,destinationAddress,destinationLat,destinationLng,destinationPlaceId,departureTime,estimatedArrivalTime,totalSeats,availableSeats,luggageLimit,approvalMode,status,closingTime,note,createdAt,updatedAt,creator,const DeepCollectionEquality().hash(_members)]);
