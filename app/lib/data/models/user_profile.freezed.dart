...
@JsonKey(name: 'contribution_score') int get contributionScore;@JsonKey(name: 'contribution_level') int get contributionLevel;@JsonKey(name: 'last_active_at') DateTime? get lastActiveAt;
