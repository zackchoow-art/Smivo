...
@JsonKey(name: 'moderation_status') String get moderationStatus;@JsonKey(name: 'moderation_note') String? get moderationNote;@JsonKey(name: 'created_at') DateTime get createdAt;@JsonKey(name: 'updated_at') DateTime get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,sellerId,title,description,category,price,transactionType,condition,status,viewCount,saveCount,inquiryCount,allowPickupChange,rentalDailyPrice,rentalWeeklyPrice,rentalMonthlyPrice,depositAmount,isPinned,pinnedDays,schoolId,pickupLocationId,const DeepCollectionEquality().hash(_images),seller,pickupLocation,moderationStatus,moderationNote,createdAt,updatedAt]);
