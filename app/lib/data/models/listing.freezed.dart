...
@JsonKey(name: 'pickup_location') PickupLocation? get pickupLocation;// NOTE: moderation_status is set by admin or automated review pipeline.
// Possible values: auto_approved, pending_review, approved, rejected, taken_down.
@JsonKey(name: 'moderation_status') String get moderationStatus;@JsonKey(name: 'moderation_note') String? get moderationNote;// Custom pickup address note — filled when seller selects "Other" location.
@JsonKey(name: 'custom_pickup_note') String? get customPickupNote;// NOTE: listing_cycle increments each time a confirmed order is cancelled
...
@JsonKey(name: 'listing_cycle') int get listingCycle;// Available date: earliest pickup/delivery date set by the seller.
// Null means "available immediately" or not specified.
@JsonKey(name: 'available_date') DateTime? get availableDate;@JsonKey(name: 'created_at') DateTime get createdAt;@JsonKey(name: 'updated_at') DateTime get updatedAt;
...
@useResult
$Res call({
 String id,@JsonKey(name: 'seller_id') String sellerId, String title, String? description, String category, double price,@JsonKey(name: 'transaction_type') String transactionType, String condition, String status,@JsonKey(name: 'view_count') int viewCount,@JsonKey(name: 'save_count') int saveCount,@JsonKey(name: 'inquiry_count') int inquiryCount,@JsonKey(name: 'allow_pickup_change') bool allowPickupChange,@JsonKey(name: 'rental_daily_price') double? rentalDailyPrice,@JsonKey(name: 'rental_weekly_price') double? rentalWeeklyPrice,@JsonKey(name: 'rental_monthly_price') double? rentalMonthlyPrice,@JsonKey(name: 'deposit_amount') double depositAmount,@JsonKey(name: 'is_pinned') bool isPinned,@JsonKey(name: 'pinned_days') int? pinnedDays,@JsonKey(name: 'school_id') String schoolId,@JsonKey(name: 'pickup_location_id') String? pickupLocationId, List<ListingImage> images, UserProfile? seller,@JsonKey(name: 'pickup_location') PickupLocation? pickupLocation,@JsonKey(name: 'moderation_status') String moderationStatus,@JsonKey(name: 'moderation_note') String? moderationNote,@JsonKey(name: 'custom_pickup_note') String? customPickupNote,@JsonKey(name: 'listing_cycle') int listingCycle,@JsonKey(name: 'available_date') DateTime? availableDate,@JsonKey(name: 'created_at') DateTime createdAt,@JsonKey(name: 'updated_at') DateTime updatedAt
});
...
/// Create a copy of Listing
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? sellerId = null,Object? title = null,Object? description = freezed,Object? category = null,Object? price = null,Object? transactionType = null,Object? condition = null,Object? status = null,Object? viewCount = null,Object? saveCount = null,Object? inquiryCount = null,Object? allowPickupChange = null,Object? rentalDailyPrice = freezed,Object? rentalWeeklyPrice = freezed,Object? rentalMonthlyPrice = freezed,Object? depositAmount = null,Object? isPinned = null,Object? pinnedDays = freezed,Object? schoolId = null,Object? pickupLocationId = freezed,Object? images = null,Object? seller = freezed,Object? pickupLocation = freezed,Object? moderationStatus = null,Object? moderationNote = freezed,Object? customPickupNote = freezed,Object? listingCycle = null,Object? availableDate = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
...
as PickupLocation?,moderationStatus: null == moderationStatus ? _self.moderationStatus : moderationStatus // ignore: cast_nullable_to_non_nullable
as String,moderationNote: freezed == moderationNote ? _self.moderationNote : moderationNote // ignore: cast_nullable_to_non_nullable
as String?,customPickupNote: freezed == customPickupNote ? _self.customPickupNote : customPickupNote // ignore: cast_nullable_to_non_nullable
as String?,listingCycle: null == listingCycle ? _self.listingCycle : listingCycle // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'seller_id')  String sellerId,  String title,  String? description,  String category,  double price, @JsonKey(name: 'transaction_type')  String transactionType,  String condition,  String status, @JsonKey(name: 'view_count')  int viewCount, @JsonKey(name: 'save_count')  int saveCount, @JsonKey(name: 'inquiry_count')  int inquiryCount, @JsonKey(name: 'allow_pickup_change')  bool allowPickupChange, @JsonKey(name: 'rental_daily_price')  double? rentalDailyPrice, @JsonKey(name: 'rental_weekly_price')  double? rentalWeeklyPrice, @JsonKey(name: 'rental_monthly_price')  double? rentalMonthlyPrice, @JsonKey(name: 'deposit_amount')  double depositAmount, @JsonKey(name: 'is_pinned')  bool isPinned, @JsonKey(name: 'pinned_days')  int? pinnedDays, @JsonKey(name: 'school_id')  String schoolId, @JsonKey(name: 'pickup_location_id')  String? pickupLocationId,  List<ListingImage> images,  UserProfile? seller, @JsonKey(name: 'pickup_location')  PickupLocation? pickupLocation, @JsonKey(name: 'moderation_status')  String moderationStatus, @JsonKey(name: 'moderation_note')  String? moderationNote, @JsonKey(name: 'custom_pickup_note')  String? customPickupNote, @JsonKey(name: 'listing_cycle')  int listingCycle, @JsonKey(name: 'available_date')  DateTime? availableDate, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Listing() when $default != null:
return $default(_that.id,_that.sellerId,_that.title,_that.description,_that.category,_that.price,_that.transactionType,_that.condition,_that.status,_that.viewCount,_that.saveCount,_that.inquiryCount,_that.allowPickupChange,_that.rentalDailyPrice,_that.rentalWeeklyPrice,_that.rentalMonthlyPrice,_that.depositAmount,_that.isPinned,_that.pinnedDays,_that.schoolId,_that.pickupLocationId,_that.images,_that.seller,_that.pickupLocation,_that.moderationStatus,_that.moderationNote,_that.customPickupNote,_that.listingCycle,_that.availableDate,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'seller_id')  String sellerId,  String title,  String? description,  String category,  double price, @JsonKey(name: 'transaction_type')  String transactionType,  String condition,  String status, @JsonKey(name: 'view_count')  int viewCount, @JsonKey(name: 'save_count')  int saveCount, @JsonKey(name: 'inquiry_count')  int inquiryCount, @JsonKey(name: 'allow_pickup_change')  bool allowPickupChange, @JsonKey(name: 'rental_daily_price')  double? rentalDailyPrice, @JsonKey(name: 'rental_weekly_price')  double? rentalWeeklyPrice, @JsonKey(name: 'rental_monthly_price')  double? rentalMonthlyPrice, @JsonKey(name: 'deposit_amount')  double depositAmount, @JsonKey(name: 'is_pinned')  bool isPinned, @JsonKey(name: 'pinned_days')  int? pinnedDays, @JsonKey(name: 'school_id')  String schoolId, @JsonKey(name: 'pickup_location_id')  String? pickupLocationId,  List<ListingImage> images,  UserProfile? seller, @JsonKey(name: 'pickup_location')  PickupLocation? pickupLocation, @JsonKey(name: 'moderation_status')  String moderationStatus, @JsonKey(name: 'moderation_note')  String? moderationNote, @JsonKey(name: 'custom_pickup_note')  String? customPickupNote, @JsonKey(name: 'listing_cycle')  int listingCycle, @JsonKey(name: 'available_date')  DateTime? availableDate, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Listing():
return $default(_that.id,_that.sellerId,_that.title,_that.description,_that.category,_that.price,_that.transactionType,_that.condition,_that.status,_that.viewCount,_that.saveCount,_that.inquiryCount,_that.allowPickupChange,_that.rentalDailyPrice,_that.rentalWeeklyPrice,_that.rentalMonthlyPrice,_that.depositAmount,_that.isPinned,_that.pinnedDays,_that.schoolId,_that.pickupLocationId,_that.images,_that.seller,_that.pickupLocation,_that.moderationStatus,_that.moderationNote,_that.customPickupNote,_that.listingCycle,_that.availableDate,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'seller_id')  String sellerId,  String title,  String? description,  String category,  double price, @JsonKey(name: 'transaction_type')  String transactionType,  String condition,  String status, @JsonKey(name: 'view_count')  int viewCount, @JsonKey(name: 'save_count')  int saveCount, @JsonKey(name: 'inquiry_count')  int inquiryCount, @JsonKey(name: 'allow_pickup_change')  bool allowPickupChange, @JsonKey(name: 'rental_daily_price')  double? rentalDailyPrice, @JsonKey(name: 'rental_weekly_price')  double? rentalWeeklyPrice, @JsonKey(name: 'rental_monthly_price')  double? rentalMonthlyPrice, @JsonKey(name: 'deposit_amount')  double depositAmount, @JsonKey(name: 'is_pinned')  bool isPinned, @JsonKey(name: 'pinned_days')  int? pinnedDays, @JsonKey(name: 'school_id')  String schoolId, @JsonKey(name: 'pickup_location_id')  String? pickupLocationId,  List<ListingImage> images,  UserProfile? seller, @JsonKey(name: 'pickup_location')  PickupLocation? pickupLocation, @JsonKey(name: 'moderation_status')  String moderationStatus, @JsonKey(name: 'moderation_note')  String? moderationNote, @JsonKey(name: 'custom_pickup_note')  String? customPickupNote, @JsonKey(name: 'listing_cycle')  int listingCycle, @JsonKey(name: 'available_date')  DateTime? availableDate, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Listing() when $default != null:
return $default(_that.id,_that.sellerId,_that.title,_that.description,_that.category,_that.price,_that.transactionType,_that.condition,_that.status,_that.viewCount,_that.saveCount,_that.inquiryCount,_that.allowPickupChange,_that.rentalDailyPrice,_that.rentalWeeklyPrice,_that.rentalMonthlyPrice,_that.depositAmount,_that.isPinned,_that.pinnedDays,_that.schoolId,_that.pickupLocationId,_that.images,_that.seller,_that.pickupLocation,_that.moderationStatus,_that.moderationNote,_that.customPickupNote,_that.listingCycle,_that.availableDate,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _Listing implements Listing {
  const _Listing({required this.id, @JsonKey(name: 'seller_id') required this.sellerId, required this.title, this.description, required this.category, required this.price, @JsonKey(name: 'transaction_type') required this.transactionType, this.condition = 'good', this.status = 'active', @JsonKey(name: 'view_count') this.viewCount = 0, @JsonKey(name: 'save_count') this.saveCount = 0, @JsonKey(name: 'inquiry_count') this.inquiryCount = 0, @JsonKey(name: 'allow_pickup_change') this.allowPickupChange = false, @JsonKey(name: 'rental_daily_price') this.rentalDailyPrice, @JsonKey(name: 'rental_weekly_price') this.rentalWeeklyPrice, @JsonKey(name: 'rental_monthly_price') this.rentalMonthlyPrice, @JsonKey(name: 'deposit_amount') this.depositAmount = 0.0, @JsonKey(name: 'is_pinned') this.isPinned = false, @JsonKey(name: 'pinned_days') this.pinnedDays, @JsonKey(name: 'school_id') required this.schoolId, @JsonKey(name: 'pickup_location_id') this.pickupLocationId, final  List<ListingImage> images = const [], this.seller, @JsonKey(name: 'pickup_location') this.pickupLocation, @JsonKey(name: 'moderation_status') this.moderationStatus = 'auto_approved', @JsonKey(name: 'moderation_note') this.moderationNote, @JsonKey(name: 'custom_pickup_note') this.customPickupNote, @JsonKey(name: 'listing_cycle') this.listingCycle = 1, @JsonKey(name: 'available_date') this.availableDate, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') required this.updatedAt}): _images = images;
...
@override@JsonKey(name: 'moderation_note') final  String? moderationNote;
// Custom pickup address note — filled when seller selects "Other" location.
@override@JsonKey(name: 'custom_pickup_note') final  String? customPickupNote;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,sellerId,title,description,category,price,transactionType,condition,status,viewCount,saveCount,inquiryCount,allowPickupChange,rentalDailyPrice,rentalWeeklyPrice,rentalMonthlyPrice,depositAmount,isPinned,pinnedDays,schoolId,pickupLocationId,const DeepCollectionEquality().hash(_images),seller,pickupLocation,moderationStatus,moderationNote,customPickupNote,listingCycle,availableDate,createdAt,updatedAt]);
