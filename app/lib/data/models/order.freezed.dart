...
@JsonKey(name: 'rental_rate_type') String? get rentalRateType;// Rental reminder preferences
@JsonKey(name: 'reminder_days_before') int get reminderDaysBefore;@JsonKey(name: 'reminder_email') bool get reminderEmail;@JsonKey(name: 'reminder_sent') bool get reminderSent;// Nested join data — populated only by specific join queries
 UserProfile? get buyer; UserProfile? get seller; OrderListingPreview? get listing;@JsonKey(name: 'pickup_location') PickupLocation? get pickupLocation;// NOTE: Set by the cancelling party so the status banner can display
// "Cancelled by [Name]" instead of the generic "Order was cancelled".
@JsonKey(name: 'cancelled_by') String? get cancelledBy;@JsonKey(name: 'listing_cycle') int get listingCycle;// NOTE: Populated only when status == 'invalidated'. Stores a snapshot
...
@JsonKey(name: 'listing_snapshot') Map<String, dynamic>? get listingSnapshot;
...
as String?,pickupLocationName: freezed == pickupLocationName ? _self.pickupLocationName : pickupLocationName // ignore: cast_nullable_to_non_nullable
...
as DateTime?,rentalRateType: freezed == rentalRateType ? _self.rentalRateType : rentalRateType // ignore: cast_nullable_to_non_nullable
...
as int,reminderEmail: null == reminderEmail ? _self.reminderEmail : reminderEmail // ignore: cast_nullable_to_non_nullable
...
as PickupLocation?,cancelledBy: freezed == cancelledBy ? _self.cancelledBy : cancelledBy // ignore: cast_nullable_to_non_nullable
as String?,listingCycle: null == listingCycle ? _self.listingCycle : listingCycle // ignore: cast_nullable_to_non_nullable
as int,listingSnapshot: freezed == listingSnapshot ? _self.listingSnapshot : listingSnapshot // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'listing_id')  String listingId, @JsonKey(name: 'buyer_id')  String buyerId, @JsonKey(name: 'seller_id')  String sellerId, @JsonKey(name: 'order_type')  String orderType,  String status, @JsonKey(name: 'school')  String school, @JsonKey(name: 'rental_start_date')  DateTime? rentalStartDate, @JsonKey(name: 'rental_end_date')  DateTime? rentalEndDate, @JsonKey(name: 'return_confirmed_at')  DateTime? returnConfirmedAt, @JsonKey(name: 'transaction_snapshot_url')  String? transactionSnapshotUrl, @JsonKey(name: 'delivery_confirmed_by_buyer')  bool deliveryConfirmedByBuyer, @JsonKey(name: 'delivery_confirmed_by_seller')  bool deliveryConfirmedBySeller, @JsonKey(name: 'delivery_photo_url')  String? deliveryPhotoUrl, @JsonKey(name: 'delivery_note')  String? deliveryNote, @JsonKey(name: 'total_price')  double totalPrice, @JsonKey(name: 'deposit_amount')  double depositAmount, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt, @JsonKey(name: 'pickup_location_id')  String? pickupLocationId, @JsonKey(name: 'pickup_location_name')  String? pickupLocationName, @JsonKey(name: 'rental_status')  String? rentalStatus, @JsonKey(name: 'deposit_refunded_at')  DateTime? depositRefundedAt, @JsonKey(name: 'return_requested_at')  DateTime? returnRequestedAt, @JsonKey(name: 'rental_rate_type')  String? rentalRateType, @JsonKey(name: 'reminder_days_before')  int reminderDaysBefore, @JsonKey(name: 'reminder_email')  bool reminderEmail, @JsonKey(name: 'reminder_sent')  bool reminderSent,  UserProfile? buyer,  UserProfile? seller,  OrderListingPreview? listing, @JsonKey(name: 'pickup_location')  PickupLocation? pickupLocation, @JsonKey(name: 'cancelled_by')  String? cancelledBy, @JsonKey(name: 'listing_cycle')  int listingCycle, @JsonKey(name: 'listing_snapshot')  Map<String, dynamic>? listingSnapshot)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Order() when $default != null:
return $default(_that.id,_that.listingId,_that.buyerId,_that.sellerId,_that.orderType,_that.status,_that.school,_that.rentalStartDate,_that.rentalEndDate,_that.returnConfirmedAt,_that.transactionSnapshotUrl,_that.deliveryConfirmedByBuyer,_that.deliveryConfirmedBySeller,_that.deliveryPhotoUrl,_that.deliveryNote,_that.totalPrice,_that.depositAmount,_that.createdAt,_that.updatedAt,_that.pickupLocationId,_that.pickupLocationName,_that.rentalStatus,_that.depositRefundedAt,_that.returnRequestedAt,_that.rentalRateType,_that.reminderDaysBefore,_that.reminderEmail,_that.reminderSent,_that.buyer,_that.seller,_that.listing,_that.pickupLocation,_that.cancelledBy,_that.listingCycle,_that.listingSnapshot);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'listing_id')  String listingId, @JsonKey(name: 'buyer_id')  String buyerId, @JsonKey(name: 'seller_id')  String sellerId, @JsonKey(name: 'order_type')  String orderType,  String status, @JsonKey(name: 'school')  String school, @JsonKey(name: 'rental_start_date')  DateTime? rentalStartDate, @JsonKey(name: 'rental_end_date')  DateTime? rentalEndDate, @JsonKey(name: 'return_confirmed_at')  DateTime? returnConfirmedAt, @JsonKey(name: 'transaction_snapshot_url')  String? transactionSnapshotUrl, @JsonKey(name: 'delivery_confirmed_by_buyer')  bool deliveryConfirmedByBuyer, @JsonKey(name: 'delivery_confirmed_by_seller')  bool deliveryConfirmedBySeller, @JsonKey(name: 'delivery_photo_url')  String? deliveryPhotoUrl, @JsonKey(name: 'delivery_note')  String? deliveryNote, @JsonKey(name: 'total_price')  double totalPrice, @JsonKey(name: 'deposit_amount')  double depositAmount, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt, @JsonKey(name: 'pickup_location_id')  String? pickupLocationId, @JsonKey(name: 'pickup_location_name')  String? pickupLocationName, @JsonKey(name: 'rental_status')  String? rentalStatus, @JsonKey(name: 'deposit_refunded_at')  DateTime? depositRefundedAt, @JsonKey(name: 'return_requested_at')  DateTime? returnRequestedAt, @JsonKey(name: 'rental_rate_type')  String? rentalRateType, @JsonKey(name: 'reminder_days_before')  int reminderDaysBefore, @JsonKey(name: 'reminder_email')  bool reminderEmail, @JsonKey(name: 'reminder_sent')  bool reminderSent,  UserProfile? buyer,  UserProfile? seller,  OrderListingPreview? listing, @JsonKey(name: 'pickup_location')  PickupLocation? pickupLocation, @JsonKey(name: 'cancelled_by')  String? cancelledBy, @JsonKey(name: 'listing_cycle')  int listingCycle, @JsonKey(name: 'listing_snapshot')  Map<String, dynamic>? listingSnapshot)  $default,) {final _that = this;
switch (_that) {
case _Order():
return $default(_that.id,_that.listingId,_that.buyerId,_that.sellerId,_that.orderType,_that.status,_that.school,_that.rentalStartDate,_that.rentalEndDate,_that.returnConfirmedAt,_that.transactionSnapshotUrl,_that.deliveryConfirmedByBuyer,_that.deliveryConfirmedBySeller,_that.deliveryPhotoUrl,_that.deliveryNote,_that.totalPrice,_that.depositAmount,_that.createdAt,_that.updatedAt,_that.pickupLocationId,_that.pickupLocationName,_that.rentalStatus,_that.depositRefundedAt,_that.returnRequestedAt,_that.rentalRateType,_that.reminderDaysBefore,_that.reminderEmail,_that.reminderSent,_that.buyer,_that.seller,_that.listing,_that.pickupLocation,_that.cancelledBy,_that.listingCycle,_that.listingSnapshot);case _:
  throw StateError('Unexpected subclass');
...
class _Order implements Order {
  const _Order({required this.id, @JsonKey(name: 'listing_id') required this.listingId, @JsonKey(name: 'buyer_id') required this.buyerId, @JsonKey(name: 'seller_id') required this.sellerId, @JsonKey(name: 'order_type') required this.orderType, this.status = 'pending', @JsonKey(name: 'school') this.school = 'Data Not Found', @JsonKey(name: 'rental_start_date') this.rentalStartDate, @JsonKey(name: 'rental_end_date') this.rentalEndDate, @JsonKey(name: 'return_confirmed_at') this.returnConfirmedAt, @JsonKey(name: 'transaction_snapshot_url') this.transactionSnapshotUrl, @JsonKey(name: 'delivery_confirmed_by_buyer') this.deliveryConfirmedByBuyer = false, @JsonKey(name: 'delivery_confirmed_by_seller') this.deliveryConfirmedBySeller = false, @JsonKey(name: 'delivery_photo_url') this.deliveryPhotoUrl, @JsonKey(name: 'delivery_note') this.deliveryNote, @JsonKey(name: 'total_price') required this.totalPrice, @JsonKey(name: 'deposit_amount') this.depositAmount = 0.0, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') required this.updatedAt, @JsonKey(name: 'pickup_location_id') this.pickupLocationId, @JsonKey(name: 'pickup_location_name') this.pickupLocationName, @JsonKey(name: 'rental_status') this.rentalStatus, @JsonKey(name: 'deposit_refunded_at') this.depositRefundedAt, @JsonKey(name: 'return_requested_at') this.returnRequestedAt, @JsonKey(name: 'rental_rate_type') this.rentalRateType, @JsonKey(name: 'reminder_days_before') this.reminderDaysBefore = 1, @JsonKey(name: 'reminder_email') this.reminderEmail = false, @JsonKey(name: 'reminder_sent') this.reminderSent = false, this.buyer, this.seller, this.listing, @JsonKey(name: 'pickup_location') this.pickupLocation, @JsonKey(name: 'cancelled_by') this.cancelledBy, @JsonKey(name: 'listing_cycle') this.listingCycle = 1, @JsonKey(name: 'listing_snapshot') final  Map<String, dynamic>? listingSnapshot}): _listingSnapshot = listingSnapshot;
...
@override@JsonKey(name: 'pickup_location_name') final  String? pickupLocationName;
...
// recalculate total_price using the buyer's original rate type (day/week/month)
// when the seller edits pricing and the buyer re-accepts the changes.
@override@JsonKey(name: 'rental_rate_type') final  String? rentalRateType;
// Rental reminder preferences
@override@JsonKey(name: 'reminder_days_before') final  int reminderDaysBefore;
@override@JsonKey(name: 'reminder_email') final  bool reminderEmail;
...
// moment the seller edited the listing. Cleared when the buyer calls
// accept_listing_changes() and the order returns to 'pending'.
 final  Map<String, dynamic>? _listingSnapshot;
// NOTE: Populated only when status == 'invalidated'. Stores a snapshot
// of key listing fields (title, price, description, condition) at the
// moment the seller edited the listing. Cleared when the buyer calls
// accept_listing_changes() and the order returns to 'pending'.
@override@JsonKey(name: 'listing_snapshot') Map<String, dynamic>? get listingSnapshot {
  final value = _listingSnapshot;
  if (value == null) return null;
  if (_listingSnapshot is EqualUnmodifiableMapView) return _listingSnapshot;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Order&&(identical(other.id, id) || other.id == id)&&(identical(other.listingId, listingId) || other.listingId == listingId)&&(identical(other.buyerId, buyerId) || other.buyerId == buyerId)&&(identical(other.sellerId, sellerId) || other.sellerId == sellerId)&&(identical(other.orderType, orderType) || other.orderType == orderType)&&(identical(other.status, status) || other.status == status)&&(identical(other.school, school) || other.school == school)&&(identical(other.rentalStartDate, rentalStartDate) || other.rentalStartDate == rentalStartDate)&&(identical(other.rentalEndDate, rentalEndDate) || other.rentalEndDate == rentalEndDate)&&(identical(other.returnConfirmedAt, returnConfirmedAt) || other.returnConfirmedAt == returnConfirmedAt)&&(identical(other.transactionSnapshotUrl, transactionSnapshotUrl) || other.transactionSnapshotUrl == transactionSnapshotUrl)&&(identical(other.deliveryConfirmedByBuyer, deliveryConfirmedByBuyer) || other.deliveryConfirmedByBuyer == deliveryConfirmedByBuyer)&&(identical(other.deliveryConfirmedBySeller, deliveryConfirmedBySeller) || other.deliveryConfirmedBySeller == deliveryConfirmedBySeller)&&(identical(other.deliveryPhotoUrl, deliveryPhotoUrl) || other.deliveryPhotoUrl == deliveryPhotoUrl)&&(identical(other.deliveryNote, deliveryNote) || other.deliveryNote == deliveryNote)&&(identical(other.totalPrice, totalPrice) || other.totalPrice == totalPrice)&&(identical(other.depositAmount, depositAmount) || other.depositAmount == depositAmount)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.pickupLocationId, pickupLocationId) || other.pickupLocationId == pickupLocationId)&&(identical(other.pickupLocationName, pickupLocationName) || other.pickupLocationName == pickupLocationName)&&(identical(other.rentalStatus, rentalStatus) || other.rentalStatus == rentalStatus)&&(identical(other.depositRefundedAt, depositRefundedAt) || other.depositRefundedAt == depositRefundedAt)&&(identical(other.returnRequestedAt, returnRequestedAt) || other.returnRequestedAt == returnRequestedAt)&&(identical(other.rentalRateType, rentalRateType) || other.rentalRateType == rentalRateType)&&(identical(other.reminderDaysBefore, reminderDaysBefore) || other.reminderDaysBefore == reminderDaysBefore)&&(identical(other.reminderEmail, reminderEmail) || other.reminderEmail == reminderEmail)&&(identical(other.reminderSent, reminderSent) || other.reminderSent == reminderSent)&&(identical(other.buyer, buyer) || other.buyer == buyer)&&(identical(other.seller, seller) || other.seller == seller)&&(identical(other.listing, listing) || other.listing == listing)&&(identical(other.pickupLocation, pickupLocation) || other.pickupLocation == pickupLocation)&&(identical(other.cancelledBy, cancelledBy) || other.cancelledBy == cancelledBy)&&(identical(other.listingCycle, listingCycle) || other.listingCycle == listingCycle)&&const DeepCollectionEquality().equals(other._listingSnapshot, _listingSnapshot));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,listingId,buyerId,sellerId,orderType,status,school,rentalStartDate,rentalEndDate,returnConfirmedAt,transactionSnapshotUrl,deliveryConfirmedByBuyer,deliveryConfirmedBySeller,deliveryPhotoUrl,deliveryNote,totalPrice,depositAmount,createdAt,updatedAt,pickupLocationId,pickupLocationName,rentalStatus,depositRefundedAt,returnRequestedAt,rentalRateType,reminderDaysBefore,reminderEmail,reminderSent,buyer,seller,listing,pickupLocation,cancelledBy,listingCycle,const DeepCollectionEquality().hash(_listingSnapshot)]);
...
as PickupLocation?,cancelledBy: freezed == cancelledBy ? _self.cancelledBy : cancelledBy // ignore: cast_nullable_to_non_nullable
as String?,listingCycle: null == listingCycle ? _self.listingCycle : listingCycle // ignore: cast_nullable_to_non_nullable
as int,listingSnapshot: freezed == listingSnapshot ? _self._listingSnapshot : listingSnapshot // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,
  ));
}
