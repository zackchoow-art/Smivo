...
@override@JsonKey(name: 'selected_message_ids') List<String>? get selectedMessageIds {
  final value = _selectedMessageIds;
  if (value == null) return null;
  if (_selectedMessageIds is EqualUnmodifiableListView) return _selectedMessageIds;
