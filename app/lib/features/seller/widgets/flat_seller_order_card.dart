...
class FlatSellerOrderCard extends ConsumerWidget {
  ...
  final FlatSellerCardType cardType;
  final dynamic order;
  ...
  Widget _buildContent(BuildContext context) {
    return switch (cardType) {
      FlatSellerCardType.activeListing => _buildActiveListingContent(context),
      FlatSellerCardType.awaitingDelivery => _buildAwaitingDeliveryContent(
        context,
      ),
      FlatSellerCardType.activeTransaction => _buildActiveTransactionContent(
        context,
      ),
      FlatSellerCardType.history => _buildHistoryContent(context),
      FlatSellerCardType.flaggedItem => _buildFlaggedItemContent(context),
    };
  }
