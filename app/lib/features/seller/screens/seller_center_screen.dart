...
class _SellerCenterScreenState extends ConsumerState<SellerCenterScreen> {
            ...
            slivers: [
              ...
              if (!Breakpoints.isMobile(MediaQuery.of(context).size.width))
                const SliverToBoxAdapter(
                  child: UnifiedPageHeader(title: 'Seller Center'),
                ),
                        ...
                        sliver: SliverToBoxAdapter(
                          child: InkWell(
                            ...
                            onTap:
                                () => setState(
                                  () =>
                                      _expandedSections['Active Listings'] =
                                          !isExpanded,
                                ),
                            child: Row(
                              children: [
                                          ...
                                          final imageUrl =
                                              listing.images.isNotEmpty
                                                  ? listing
                                                      ...
                                                      .imageUrl
                                                  : null;
                                          return _buildActiveListingCard(
                                            listing,
                                            imageUrl,
                                          );
              ...
              ordersAsync.when(
                ...
                data: (orders) {
                  ...
                  final awaitingDelivery =
                      _searchQuery.isEmpty
                          ? allAwaitingDelivery
                          : allAwaitingDelivery.where((o) {
                            final q = _searchQuery.toLowerCase();
                            final title = o.listing?.title.toLowerCase() ?? '';
                            final buyer =
                                o.buyer?.displayName?.toLowerCase() ?? '';
                        ...
                        sliver: SliverToBoxAdapter(
                          child: InkWell(
                            ...
                            onTap:
                                () => setState(
                                  () =>
                                      _expandedSections['Awaiting Delivery'] =
                                          !isExpanded,
                                ),
                            child: Row(
                              children: [
                                  ...
                                  isFlat
                                      ...
                                      : SliverList(
                                        delegate: SliverChildBuilderDelegate((
                                          ...
                                          return _buildAwaitingDeliveryCard(
                                            order,
                                            hasUnread,
                                          );
                        ...
                        sliver: SliverToBoxAdapter(
                          child: InkWell(
                            ...
                            onTap:
                                () => setState(
                                  () =>
                                      _expandedSections['Active Transactions'] =
                                          !isExpanded,
                                ),
                            child: Row(
                              children: [
                                  ...
                                  isFlat
                                      ? SliverResponsiveGrid(
                                        ...
                                        itemBuilder: (context, index) {
                                          ...
                                          final statusLabel =
                                              order.rentalStatus != null
                                                  ? (resolver?.rentalLabel(
                                                        order.rentalStatus!,
                                                      ) ??
                                                      order.rentalStatus!
                                                          .replaceAll('_', ' ')
                ...
                data: (orders) {
                  return listingsAsync.when(
                    ...
                    data: (listings) {
                      ...
                      final listingsWithActiveSibling =
                          orders
                              .where(
                                (o) =>
                                    o.status == 'confirmed' ||
                        ...
                        historyItems.add(
                          _HistoryItem(
                            title:
                                ...
                                'Order',
                            subtitle:
                                '${formatOrderPrice(o)} · ${o.buyer?.displayName ?? 'Buyer'}',
                            isCompleted: true,
                            orderId: o.id,
                            ...
                            imageUrl:
                                o.listing?.images.firstOrNull?.imageUrl ??
                                fullListing?.images.firstOrNull?.imageUrl,
                            onTap: () {
                              final hasUnread = notifications.any(
                                (n) => !n.isRead && n.relatedOrderId == o.id,
                              );
                        ...
                        historyItems.add(
                          _HistoryItem(
                            ...
                            createdAt:
                                ...
                                groupOrders.first.createdAt,
                            updatedAt:
                                groupOrders
                                    .first
                                    .updatedAt, // Use most recent update
                            imageUrl:
                                fullListing?.images.firstOrNull?.imageUrl ??
                                listingPreview?.images.firstOrNull?.imageUrl,
                            onTap:
                                () => _showMergedCancelledDetails(
                                  context,
                                  fullListing,
                                  groupOrders,
                                ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    DateFormat('MM/dd HH:mm').format(order.updatedAt.toLocal()),
                    style: typo.labelSmall.copyWith(
                      fontSize: 10,
                      fontWeight: FontWeight.bold,
                      color: colors.primary,
  ...
  void _showMergedCancelledDetails(
    ...
    showDialog(
      ...
      builder:
          (context) => AlertDialog(
            ...
            title: Text(
              listing?.title ?? 'Cancelled Offers',
