...
/// A square grid card for saved listings used in the Flat theme.
class FlatSavedListingCard extends StatelessWidget {
  const FlatSavedListingCard({super.key, required this.savedListing});
