...
/// Flat-themed grid card for listings displayed from item 4 onwards.
///
...
class FlatGridListingCard extends StatelessWidget {
  const FlatGridListingCard({super.key, required this.listing});
