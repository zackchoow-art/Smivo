-- ============================================================
-- Migration 00087: Fix bare DELETE (pg_safeupdate)
-- ============================================================
-- Supabase enables pg_safeupdate by default, which rejects
-- DELETE statements without a WHERE clause. Add "WHERE true"
-- to all unconditional deletes in the cleanup function.
-- ============================================================
...
BEGIN
  ...
  -- NOTE: "WHERE true" is required because Supabase enables pg_safeupdate,
  -- which rejects DELETE without a WHERE clause.
