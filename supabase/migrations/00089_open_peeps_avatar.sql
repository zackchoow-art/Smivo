-- ============================================================
-- Migration 00089: Open Peeps Avatar and Display Name on Signup
-- ============================================================
...
AS $$
  ...
  v_avatar_url text;
begin
  -- Generate random avatar seed using Open Peeps
  ...
  if new.raw_user_meta_data->>'bypass_edu' = 'true' then
    ...
    insert into public.user_profiles (id, email, school_id, is_verified, display_name, avatar_url)
    values (new.id, new.email, v_school_id, true, v_display_name, v_avatar_url);
  ...
  -- Create user_profiles row with school_id, display_name and avatar_url
  insert into public.user_profiles (id, email, school_id, display_name, avatar_url)
  values (new.id, new.email, v_school_id, v_display_name, v_avatar_url);
